package tz.or.mkapafoundation.whistleblower.config.timezone;
...
import tz.or.mkapafoundation.whistleblower.repository.timezone.DateTimeWrapper;
import tz.or.mkapafoundation.whistleblower.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM bmf_date_time_wrapper where id=%d", fieldName, id);
    }
