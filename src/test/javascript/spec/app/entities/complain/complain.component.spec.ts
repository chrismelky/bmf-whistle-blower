...
import { ComplainComponent } from 'app/entities/complain/complain.component';
...
describe('Component Tests', () => {
  describe('Complain Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.complains && comp.complains[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
